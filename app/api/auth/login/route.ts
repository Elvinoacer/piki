...
async function loginWithOtp(req: NextRequest, body: unknown, locale: import("@/app/generated/prisma/client").Locale) {
...
async function loginWithPassword(req: NextRequest, body: unknown, locale: import("@/app/generated/prisma/client").Locale) {
...
function assertNotSuspended(
  user: { status: string; locale: import("@/app/generated/prisma/client").Locale },
  fallbackLocale: import("@/app/generated/prisma/client").Locale
) {
